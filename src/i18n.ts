...
type Key =
  ...
  | "cart" | "subtotal" | "emptyCart" | "skipToContent";

export const DICT: Record<Locale, Record<Key, string>> = {
  en: { home: "Home", products: "Products", blog: "Blog", pricing: "Pricing", dashboard: "Dashboard", account: "Account", faq: "FAQ", contact: "Contact", about: "About", metrics: "Metrics", docs: "API Docs", admin: "Admin", privacy: "Privacy", terms: "Terms", license: "License", tagline: "every layer from one contract.", search: "Search", addToCart: "Add to cart", checkout: "Checkout", cart: "Cart", subtotal: "Subtotal", emptyCart: "Your cart is empty.", skipToContent: "Skip to content" },
